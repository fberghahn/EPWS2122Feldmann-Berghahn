...
class MapsFragment : Fragment(), GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    override fun onMapReady(p0: GoogleMap) {
        arguments?.let {
            ...
            cacheid=it.getString("eventid").toString()
...
//        mMap.setOnMarkerClickListener(this)
        ...
        found_button.setOnClickListener{
            val currentCache = Event(cacheid,creatorid,title,cacheLocation.latitude,cacheLocation.longitude,imageString,kategorie = null)
            currentCache.found=true
            currentCache.Eventname= currentCache.Eventname+" (Zugesagt)"
